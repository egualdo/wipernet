(function($) {
    ...
    setTimeout(function(){
        $("#line-chart-sparkline").sparkline([5, 10, 20, 14, 17, 21, 20, 10, 4, 13,0, 10, 30, 40, 10, 15, 20], {
            ...
            lineColor: WipernetAdminConfig.primary,
            fillColor: 'rgba(145, 46, 252, 0.40)',
            highlightLineColor: WipernetAdminConfig.primary,
            highlightSpotColor: WipernetAdminConfig.primary,
            targetColor: WipernetAdminConfig.primary,
            performanceColor: WipernetAdminConfig.primary,
            boxFillColor: WipernetAdminConfig.primary,
            medianColor: WipernetAdminConfig.primary,
            minSpotColor: WipernetAdminConfig.primary
        });
    });
    ...
    $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
        ...
        tooltipClassname: 'chart-sparkline',
        chartRangeMax: '50',
        lineColor: WipernetAdminConfig.secondary,
...
var sparkline_chart = {
  init: function() {
    setTimeout(function(){
        ...
        height: '100%',
        tooltipClassname: 'chart-sparkline',
        barColor: WipernetAdminConfig.primary
    }), $("#pie-sparkline-chart").sparkline([1.5, 1, 1, 0.5], {
        type: 'pie',
        width: '100%',
        height: '100%',
        sliceColors: ['#51bb25','#f8d62b', WipernetAdminConfig.secondary , WipernetAdminConfig.primary ],
        tooltipClassname: 'chart-sparkline'
    });
    }
};
