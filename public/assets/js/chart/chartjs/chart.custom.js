...
var barData = {
    ...
    datasets: [{
        ...
        strokeColor: WipernetAdminConfig.primary,
        highlightFill: "rgba(145, 46, 252, 0.6)",
        highlightStroke: WipernetAdminConfig.primary ,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(247, 49, 100, 0.4)",
        strokeColor: WipernetAdminConfig.secondary ,
        highlightFill: "rgba(247, 49, 100, 0.6)",
        highlightStroke: WipernetAdminConfig.secondary,
...
var polarData = [
    {
        ...
        highlight: WipernetAdminConfig.primary,
        label: "Yellow"
    }, {
        value: 50,
        color: "#f8d62b",
        ...
        value: 120,
        color: WipernetAdminConfig.secondary ,
        highlight: WipernetAdminConfig.secondary ,
        label: "Dark Grey"
    }
];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: WipernetAdminConfig.primary ,
        pointColor: WipernetAdminConfig.primary ,
        ...
        strokeColor: WipernetAdminConfig.secondary ,
        pointColor: WipernetAdminConfig.secondary ,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: WipernetAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: WipernetAdminConfig.primary,
        pointColor: WipernetAdminConfig.primary,
        pointStrokeColor: WipernetAdminConfig.primary,
        pointHighlightFill: WipernetAdminConfig.primary ,
