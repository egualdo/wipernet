...
function drawBasic() {
  if ($("#column-chart1").length > 0) {
      ...
      b = {
        ...
        height: 400,
        width:'100%',
          colors: [WipernetAdminConfig.primary, WipernetAdminConfig.secondary , "#51bb25"]
  ...
  if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
       colors: ["#f8d62b", "#51bb25" , "#a927f9"  , WipernetAdminConfig.secondary , WipernetAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
        colors: ["#f8d62b", "#a927f9" , "#51bb25", WipernetAdminConfig.secondary , WipernetAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        slices: {  4: {offset: 0.2},
          ...
          colors: ["#dc3545", WipernetAdminConfig.primary , WipernetAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b","#dc3545", WipernetAdminConfig.primary , "#f8d62b", "#51bb25", WipernetAdminConfig.primary , WipernetAdminConfig.secondary ,"#51bb25", WipernetAdminConfig.primary , "#a927f9", "#f8d62b", WipernetAdminConfig.primary , WipernetAdminConfig.primary, "#a927f9", WipernetAdminConfig.secondary , WipernetAdminConfig.primary , "#51bb25"]
        };
  ...
  if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width:'100%',
        colors: [WipernetAdminConfig.primary, WipernetAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b"]
    };
  ...
  if ($("#area-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 400,
        colors: [ WipernetAdminConfig.primary , WipernetAdminConfig.secondary ]
      };
  ...
  if ($("#area-chart2").length > 0) {
    ...
    var options = {
      ...
      width:'100%',
      height: 400,
      colors: [WipernetAdminConfig.primary , WipernetAdminConfig.secondary , "#51bb25", "#f8d62b"]
    };
    ...
    var options = {
        ...
        gantt: {
            ...
            arrow: {
                ...
                palette: [
                    {
                        "color": WipernetAdminConfig.primary,
                        "dark": WipernetAdminConfig.secondary ,
                        "light": "#047afb"
                    }
                ]
