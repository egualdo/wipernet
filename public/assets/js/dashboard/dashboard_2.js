...
var options1 = {
  ...
  fill: {
    ...
    colors: [ WipernetAdminConfig.primary , WipernetAdminConfig.primary , WipernetAdminConfig.primary],
  },
  colors: [WipernetAdminConfig.primary, WipernetAdminConfig.secondary, WipernetAdminConfig.secondary],
};
...
var options2 = {
 ...
 colors: [ WipernetAdminConfig.primary , WipernetAdminConfig.primary , WipernetAdminConfig.primary , WipernetAdminConfig.primary ],
  plotOptions: {
    bar: {
      vertical: true,
      columnWidth: '40%',
  ...
  fill: {
    ...
    colors: [function({ value, seriesIndex, w }) {
      if(value < 0.75) {
          ...
          return WipernetAdminConfig.primary
      }
    }]
  }
};
