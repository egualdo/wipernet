    ...
    var optionslinechart2 = {
        ...
        colors:[WipernetAdminConfig.secondary],
        series: [
            {
                name: 'series1',
...
var optionsuserchart = {
    ...
    colors:[WipernetAdminConfig.primary, WipernetAdminConfig.secondary, '#51bb25', '#544fff'],
    title: {
...
yaxis: {
    ...
    var optionsProgress1 = {
        ...
        fill: {
            ...
            type: 'gradient',
            gradient: {
                gradientToColors: [WipernetAdminConfig.primary]
            }
        },
        series: [{
            name: 'Process 1',
