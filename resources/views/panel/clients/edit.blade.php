...
<h3> {{__('Edit')}} {{__('Clients')}}</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item"> {{__('Clients')}}</li>
<li class="breadcrumb-item active"> {{__('Edit')}} {{__('Clients')}}</li>
@endsection
            ...
            <div class="col-xl-12">
                <form method="POST" action="{{ route('clients.update', $client->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="card-header">
                        {{-- <h4 class="card-title mb-0">{{ __('Edit Client') }}</h4> --}}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select required name="country_id[]" id="country_id" class="form-control select2"
                                        ...
                                        <option value="{{ $country->id }}" {{ in_array($country->id,
                                            $client->country_id) ? 'selected' : '' }}>{{ $country->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="checkbox" id="checkbox2" >{{ __('All') }}
                                    ...
                                    <select required name="city_id[]" id="city_id" class="form-control select2"
                                        ...
                                        <option value="{{ $city->id }}" {{ in_array($city->id, $client->city_id) ?
                                    ...
                                    <div id="idiom-{{$array_data[$i][0]->idiom_id}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <br />
                                                {{-- <label for="photo_{{$array_data[$i][0]->idiom_id}}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input onchange="previewImage(event)" id="photo" type="file"
                                    class="form-control mt-2 @error('photo') is-invalid @enderror" name="photo">
                                @error('photo')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
