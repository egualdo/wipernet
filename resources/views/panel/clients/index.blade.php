...
<h3>{{__('List')}} {{__('Clients')}}</h3> <br>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item"> {{__('Clients')}}</li>
<li class="breadcrumb-item active"> {{__('Clients')}} index</li>
@endsection
...
<div class="container-fluid">
    <h4>{{__('New Element')}} <a class="btn btn-outline-success"
            href="{{ route('clients.create') }}">{{__('here.')}}</a></h4>
            ...
            <tbody>
                <tr>
                    ...
                    <th>
                        ...
                        @foreach(App\Models\ClientsIdiom::where('client_id',$client->id)->get()
                        as $t)
                    ...
                    <th class="counter"><a href="{{ route('clients.edit', $client->id) }}"
                            class="btn btn-outline-primary"><i data-feather="edit-2"></i></a></th>
                    <th class="counter"><a href="{{ route('clients.show', $client->id) }}"
