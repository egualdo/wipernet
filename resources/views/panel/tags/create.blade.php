...
<h3> {{__('Create')}} {{__('Tags')}}</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item"> {{__('Tags')}}</li>
<li class="breadcrumb-item active"> {{__('Create')}} {{__('Tags')}}</li>
@endsection
...
<div class="container-fluid">
    <div class="edit-profile">
        <div class="row">
            ...
            <div class="col-xl-12">
                <form method="POST" action="{{ route('tags.store') }}" enctype="multipart/form-data" class="card">

                    @csrf
                    <div class="card-header">
                        {{-- <h4 class="card-title mb-0">{{ __('Create New tag') }}</h4> --}}
