...
<h3> {{__('Show')}} {{__('Staff')}}</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item"> {{__('Staff')}}</li>
<li class="breadcrumb-item active"> {{__('Show')}} {{__('Staff')}}</li>
@endsection
...
<div class="container-fluid">
    <div class="edit-profile">
        <div class="row">
            ...
            <div class="col-xl-12">
                <form method="POST" action="{{ route('staffs.update', $staf->id) }}" enctype="multipart/form-data"
                    class="card">

                    @csrf
                    @method('PUT')
                    <div class="card-header">
                        {{-- <h4 class="card-title mb-0">{{ __('Show Staff') }}</h4> --}}
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12">
                                    @if (is_array($staf->country_id))
                                    @if(count($staf->country_id) > 0)
                                    @foreach ($countries as $country)
                                    @if (in_array($country->id, $staf->country_id))
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (is_array($staf->city_id))
                                    @if(count($staf->city_id) > 0)
                                    @foreach ($cities as $city)
                                    @if (in_array($city->id, $staf->city_id))
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12">
                                    @if($staf->photo)
                                    <img id="image-preview" src="{{ $staf->photo }}"
