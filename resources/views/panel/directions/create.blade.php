...
@section('title', 'Create Directions')
...
<h3> {{__('Create')}} {{__('Directions')}}</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item"> {{__('Directions')}}</li>
<li class="breadcrumb-item active"> {{__('Create')}} {{__('Directions')}}</li>
@endsection
...
<div class="container-fluid">
    <div class="edit-profile">
        <div class="row">
            ...
            <div class="col-xl-12">
                <form method="POST" action="{{ route('directions.store') }}" enctype="multipart/form-data" class="card">

                    @csrf
                    <div class="card-header">
                        {{-- <h4 class="card-title mb-0">{{ __('Create New Direction') }}</h4> --}}
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12">
                                    <input id="acronym" type="text"
                                        ...
                                        value="{{ old('acronym') }}" autocomplete="acronym" autofocus>
                                    ...
                                    <div id="idiom-{{$idiom->id}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea id="direction_{{$idiom->id}}"
                                                        class="form-control @error('direction_es') is-invalid @enderror"
                                                        name="direction_{{$idiom->id}}">{{ old('direction_es') }}</textarea>
