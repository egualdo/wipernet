...
<h3> {{__('Create')}} {{__('Services')}}</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item"> {{__('Services')}}</li>
<li class="breadcrumb-item active"> {{__('Create')}} {{__('Services')}}</li>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                    ...
                    <div class="card-header">
                        <h4 class="card-title mb-0">{{ __('Create New Service') }}</h4>
...
function updateFields() {
 ...
 function ajaxFilterservicesView() {
        ...
        $.ajax({
            url: '{{ route('taskboardViewservices') }}',
            data: data,
