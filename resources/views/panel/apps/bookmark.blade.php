                                             ...
                                             <div class="details-website">
                                                ...
                                                <div class="desciption-data">
                                                   <div class="title-bookmark">
                                                      ...
                                                      <p class="weburl_2">https://angular.pixelstrap.com/Wipernet/landing</p>
                                                      <div class="hover-block">
                                                         <ul>
                                                      ...
                                                      <div class="content-general">
                                                         <p class="desc_2">Wipernet is beautifully crafted, clean and modern designed admin theme</p>
                                          ...
                                          <div class="card card-with-border bookmark-card o-hidden">
                                             <div class="details-website">
                                                ...
                                                <div class="desciption-data">
                                                   <div class="title-bookmark">
                                                      <h6 class="title_0">Admin Template</h6>
                                                      <p class="weburl_0">http://admin.pixelstrap.com/Wipernet/ltr/landing-page.html</p>
                                                      <div class="hover-block">
                                                         <ul>
                                                            <li><a href="" onclick="editBookmark(0)" data-bs-toggle="modal" data-bs-target="#edit-bookmark"><i data-feather="edit-2"></i></a></li>
                                                            <li><a href="#"><i data-feather="link"></i></a></li>
                                                      ...
                                                      <div class="content-general">
                                                         <p class="desc_0">Wipernet is beautifully crafted, clean and modern designed admin theme with 6 different demos and light - dark versions.</p>
                                                         <span class="collection_0">General</span>
                                                      </div>
                                                   </div>
                                                </div>
                                 ...
                                 <div class="modal-body">
                                    <form class="form-bookmark needs-validation" novalidate="">
                                       <div class="row g-2">
                                          <div class="mb-3 mt-0 col-md-12">
                                             <label>Web Url</label>
                                             <input class="form-control" id="editurl" type="text" required="" autocomplete="off" value="http://admin.pixelstrap.com/Wipernet/ltr/landing-page.html">
                                          </div>
                                          <div class="mb-3 mt-0 col-md-12">
                                             <label>Title</label>
                                          ...
                                          <div class="mb-3 mt-0 col-md-12">
                                             <label>Description</label>
                                             <textarea class="form-control" id="editdesc" required="" autocomplete="off">Wipernet is beautifully crafted, clean and modern designed admin theme with 6 different demos and light - dark versions.</textarea>
                                          </div>
                                          <div class="mb-3 mt-0 col-md-6">
                                             <label>Group</label>
